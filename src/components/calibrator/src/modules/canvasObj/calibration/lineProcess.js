...
class LineProcess extends CalibrationProcess {
  constructor(params) {
    super(params);
    this.updateProcessData(this.scope.coordinates[0]);
  }
}
LineProcess.prototype.updateProcessData = function(point) {
...
LineProcess.prototype.enlarge = function({ newRatio, oldRatio, newPoint, oldPoint }) {
...
LineProcess.prototype.getScope = function() {
  const {
...
LineProcess.prototype.setScope = function(scope) {
...
LineProcess.prototype.unFormat = function(image, calibrationKey, indexKey) {
...
LineProcess.prototype.move = function(distX, distY) {
