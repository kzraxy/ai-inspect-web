...
class BAChain extends Calibration {
  constructor(data) {
    super(data);
  }
}

BAChain.prototype.getScope = function () {
  const {
...
BAChain.prototype.setScope = function (scope) {
...
BAChain.prototype.format = function (data) {
  const {
    type: propType,
...
BAChain.prototype.unFormat = function (image, calibrationKey, indexKey) {
...
BAChain.prototype.enlarge = function ({ newRatio, oldRatio, newPoint, oldPoint }) {
...
BAChain.prototype.move = function (distX, distY) {
  this.moveControlsAndCoordinates(distX, distY);
  this.updateLabelPoint();
};
BAChain.prototype.adjustControl = function (index, { distX, distY }) {
