...
class Chain extends Calibration {
  constructor(data) {
    super(data);
  }
}

Chain.prototype.getScope = function () {
  const {
...
Chain.prototype.setScope = function (scope) {
...
Chain.prototype.format = function (data) {
  const {
    type: propType,
...
Chain.prototype.unFormat = function (image, calibrationKey, indexKey) {
...
Chain.prototype.enlarge = function ({ newRatio, oldRatio, newPoint, oldPoint }) {
...
Chain.prototype.move = function (distX, distY) {
  this.moveControlsAndCoordinates(distX, distY);
  this.updateLabelPoint();
};
Chain.prototype.adjustControl = function (index, { distX, distY }) {
