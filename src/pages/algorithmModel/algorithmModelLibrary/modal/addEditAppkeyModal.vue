    ...
    <el-dialog title="配置训练平台账号" :visible="visible" @close="close" :area="[560,340]" :close-on-click-modal=false>
      ...
      <el-form ref="accountForm" :model="accountForm" label-width="100px" :rules="rules" style="margin-top: 20px;" >
        <el-form-item label="appKey" prop="appKey">
          <el-input v-model="accountForm.appKey" clearable placeholder="请输入APPKEY" :maxlength="32" style="width: 220px;" :disabled="editAppkeyFlag"></el-input>
        </el-form-item>
        <el-form-item label="appSecret" prop="appSecret">
          <el-input v-model="accountForm.appSecret" clearable placeholder="请输入SECRET" :maxlength="32" style="width: 220px;"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { synchronousModel, addAccount, editAccount, deleteAccount } from '../proxy'
