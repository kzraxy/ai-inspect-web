      ...
      <div class="add_item">
        ...
        <el-popover ref="popover5" placement="bottom" width="180" popper-class="tag_color_popover">
          <div class="color_popover">
            <div v-for="(item,index) in colorList" :key="index" :style="{'background':item }" class="color_div" @click="chooseColor(item)">
              <div v-show="form.color === item" class="text icon iconfont h-icon-done"></div>
            </div>
          </div>
